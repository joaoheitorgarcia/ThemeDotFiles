...
Rectangle {
    ...
    Singletons.Icon {
        id: iconItem
        source: generalConfigs.icons.notifications.list
    ...
    PopupWindow {
        ...
        anchor.item: notificationListBtn
        anchor.edges: Edges.Bottom | Edges.Left
        anchor.margins.top: 35
        implicitWidth: notificationListContent.width
        implicitHeight: notificationListContent.height
        visible: false
        color: "transparent"

        PopUpContent.NotificationListPopup {
    ...
    MouseArea {
        ...
        onClicked: Managers.PopupManager.toggle(notificationListPopup)
    }
}
